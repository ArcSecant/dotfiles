...
--
myWorkspaces = [term, web, code, mail, steam] ++ extraWorkspaces
...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  -- Takes screenshot
  , ((modMask .|. shiftMask, xK_Print), spawn "gnome-screenshot -ca")
  ...
  -- Brightness up.
  , ((0, 0x1008FF02),
    spawn "echo jesuisfatigue | sudo -S brightness -inc 750")

  -- Brightness down.
  , ((0, 0x1008FF03),
    spawn "echo jesuisfatigue | sudo -S brightness -dec 750")
...
myStartupHook = do
 spawn "compton --backend glx --vsync opengl -fcCz -l -17 -t -17 -D4 -m 0.01"
